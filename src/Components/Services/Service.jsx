          ...
          <Box sx={{ 
                    ...
                    label={
                      <Box sx={{ display: 'flex', alignItems: 'center', width: '100%' }}>
                        <Box sx={{ 
                          ...
                          p: { xs: 0.5, lg: 1 },
                          borderRadius: 2,
                          backgroundColor: selectedTab === service.id ? `${service.color}20` : (isLightMode ? '#f5f5f5' : '#2a2a2a')
                        }}>
                          {React.cloneElement(service.icon, { 
                            sx: { 
                              fontSize: { xs: 24, lg: 32 }, 
                              color: selectedTab === service.id ? service.color : colors.textSecondary
                            } 
                          })}
                        </Box>
                        <Box sx={{ flex: 1, minWidth: 0 }}>
                          <Typography variant="subtitle1" sx={{ 
                            ...
                            mb: { xs: 0.5, lg: 1 },
                            color: selectedTab === service.id ? service.color : colors.text,
            ...
            <Box sx={{ 
              ...
              <Box sx={{ 
                ...
                <Divider sx={{ my: 4, borderWidth: 2, borderColor: colors.divider }} />
                ...
                <Divider sx={{ my: 6, borderWidth: 3, borderColor: colors.divider }} />
              ...
              <Grid item xs={12} md={4} key={index} sx={{ display: 'flex' }}>
                <Paper
                  sx={{
                    ...
                    position: 'relative',
                    borderRadius: 4,
                    boxShadow: isLightMode ? '0 4px 20px rgba(0,0,0,0.1)' : '0 4px 20px rgba(0,0,0,0.3)',
                    border: '2px solid',
                    borderColor: colors.divider,
                    backgroundColor: colors.paper,
                    transition: 'all 0.4s ease',
